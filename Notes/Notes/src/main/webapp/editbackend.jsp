...
int id=Integer.parseInt(request.getParameter("id"));
 try{
	...
	Query query = session2.createQuery(" update addnotes set Title=:_title,Paragraph=:_paragraph where nid=:_id");
    query.setParameter("_title", title);
    query.setParameter("_paragraph", paragraph);
	...
	%>
	 <div class="box">
         ...
         <div class="text_suc">
             <h1>Thank You!</h1>
             <p style="margin-top: -10px;">Notes Edited Successfully </p>
