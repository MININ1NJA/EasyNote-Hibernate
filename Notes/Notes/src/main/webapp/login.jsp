...
<html>
    ...
    <body>
    <div id="login">
            <h3 class="text-center text-white pt-5">Login to Add Notes</h3>
            <div class="container">
                <div id="login-row" class="row justify-content-center align-items-center">
                    <div id="login-column" class="col-md-6">
                        <div id="login-box" class="col-md-12">
                            <form id="login-form" class="form" action="loginbackend.jsp" method="post" >
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="register.jsp" id="link">Register?</a><br> 
